...
import com.izabelvidal.cursoMC.domain.PagamentoComCartao;
...
import com.izabelvidal.cursoMC.domain.enums.Perfil;
import com.izabelvidal.cursoMC.domain.enums.TipoCliente;
...
import com.izabelvidal.cursoMC.repositories.EnderecoRepository;
...
import com.izabelvidal.cursoMC.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException{
		...
		Cidade c1 = new Cidade(null, "Belo Jardim", est1);
		Cidade c2 = new Cidade(null, "Campina Grande", est2);
		Cidade c3 = new Cidade(null, "Caruaru", est1);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "izabelvidal99@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "belgermanotta666@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
